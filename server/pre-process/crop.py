...
argParser.add_argument(
    ...
    "--size",
    default=256,
    help="new image size after cropping and resizing",
    type=int,
)
argParser.add_argument(
    "-f",
    "--folder",
    required=True,
    help="relative path to directory containing images to be cropped",
    type=str,
)
...
if __name__ == "__main__":
    cropAndResizeImages(
        path=RELATIVE_PATH_TO_FOLDER, newPath=NEW_FOLDER_NAME, imgSize=NEW_IMAGE_SIZE
    )
